  ...
  return (
    <Grid item xs={12} sm={6}>
      <Box alignItems={"center"} justifyContent={"center"} className={classes.root}>
        <Box maxWidth={800} alignItems={"center"} justifyContent={"center"} className={classes.root}>
          {data.map(accordion => {
            const { id, heading, secondaryHeading, details } = accordion;
            return (

              <AccordionGroup elevation={3} className={classes.root}
              ...
              >{root}
                ...
                >
                  <Typography fontSize={16} className={classes.heading}>{heading}</Typography>
                  <Typography fontSize={16} className={classes.secondaryHeading}>
                    {secondaryHeading}
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
